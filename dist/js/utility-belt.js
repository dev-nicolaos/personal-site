...
const mapObject = (obj, func) => Object.keys(obj).map((key, index) => func(obj[key], key, index, obj));
...
class UtilityBelt extends HTMLElement {
  constructor() {
    ...
    this.querySelectorAll("summary").forEach(el => el.addEventListener("click", e => {
      e.preventDefault();
